  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, hsla(38,70%,55%,0.13) 0%, transparent 65%)',
        filter: 'blur(50px)', pointerEvents: 'none',
      }} />
      <div style={{
        position: 'absolute', bottom: '-20%', left: '-10%',
        width: '500px', height: '500px', borderRadius: '50%',
        background: 'radial-gradient(circle, hsla(220,70%,60%,0.07) 0%, transparent 65%)',
        filter: 'blur(50px)', pointerEvents: 'none',
      }} />
      ...
      <div
        ...
        style={{
          ...
          padding: '4rem 3rem', maxWidth: '460px', position: 'relative', zIndex: 1,
        }}
      >
        {/* Logo */}
        ...
        <p style={{ fontSize: '0.95rem', color: 'hsl(36,7%,58%)', lineHeight: 1.7, marginBottom: '2.5rem' }}>
          Sign up in seconds with Google. No credit card needed.
          Your notes, tasks, and team — all in one beautiful place.
        </p>

        {/* Feature list */}
        {[
          { icon: '📋', label: 'Smart Kanban & Task Boards' },
          { icon: '✍️', label: 'AI-powered Notes & Documents' },
          { icon: '🎨', label: 'Infinite Whiteboard Canvas' },
        ...
        <div style={{
          display: 'flex', alignItems: 'center', gap: '12px',
          marginTop: '2rem', padding: '14px 16px',
          borderRadius: '12px', background: 'hsl(30 6% 13%)',
          ...
          <div>
            <div style={{ fontSize: '0.8rem', fontWeight: 700, color: 'hsl(45,15%,88%)' }}>
              Join 10,000+ users
            </div>
            <div style={{ fontSize: '0.72rem', color: 'hsl(36,7%,55%)' }}>
          ...
          <SignUp
            ...
            appearance={{
              ...
              elements: {
                ...
                identityPreviewText: { color: 'hsl(45,15%,80%)' },
              },
            }}
          />
        </ClerkLoaded>
